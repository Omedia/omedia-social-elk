...
async function exportTokens() {
  ...
  const data = {
    '/': 'Generated by Omedia Social, you can import it to Omedia Social to restore the tokens.',
  ...
  saveAs(blob, `omedia-social-users-tokens-${new Date().toISOString().slice(0, 10)}.json`)
}
...
async function importTokens() {
  ...
  try {
    ...
    console.error(e)
    alert('Invalid Omedia Social tokens file')
  }
}
</script>
