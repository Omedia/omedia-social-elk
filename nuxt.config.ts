  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        { property: 'og:title', content: 'Omedia Social' },
        { property: 'og:description', content: 'A Mastodon web client for the Omedia team' },
        { property: 'og:type', content: 'website' },
        { property: 'og:image', content: 'https://omedia.social/pwa-512x512.png' },
        { property: 'og:image:width', content: '512' },
        { property: 'og:image:height', content: '512' },
        { property: 'og:site_name', content: 'Omedia Social' },
